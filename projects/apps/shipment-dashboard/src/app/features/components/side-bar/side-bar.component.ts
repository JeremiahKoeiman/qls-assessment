...
import { heroCog6Tooth, heroDocumentText, heroHome, heroTruck } from '@ng-icons/heroicons/outline';
...
@Component({
  ...
  viewProviders: [provideIcons({ heroTruck, heroHome, heroCog6Tooth, heroDocumentText })]
})
